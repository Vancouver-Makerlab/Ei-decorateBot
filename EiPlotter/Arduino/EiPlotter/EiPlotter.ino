/***************************************************************************************************
  ...
  EI-Plotter - A low-cost EggBot clone
  ...
  PC to receive commands.  (wifi serial link, webpage Gui and android app coming soon!)

  This sketch was written to work with InkScape and the modified EggBot
  extension V 2.5.0A.

  In order to compile, make sure you have the following libraries:
  ***AccelStepper - http://www.airspayce.com/mikem/arduino/AccelStepper/
  ***Bounce2 - https://github.com/thomasfredericks/Bounce2

  Original Fork Written by Thomas Frey his full write up here http://tomscircuits.blogspot.com/
  -he did most of the heavy lifting :)
  
  updated by Nate: Stripped down to work with the esp8266, 
  implements all eggbot functions from version 2.3
  -future development will be for esp32! (servo.h library needs updating)
...
//change this to adjust for jerk and backlash
